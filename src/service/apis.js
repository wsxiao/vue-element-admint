...
import {INTERFACEURL as INTERFACE_URL} from "./interface_urls";

export const APIS = {
  // 1.1 采购模版下载
  'postCodesDownload': params => post(INTERFACE_URL.codesDownload, params, 'form'),
  // 1.2 采购商品导⼊入
  'postCodesUpload':params => post(INTERFACE_URL.codesUpload, params, 'form'),
  // 2.1 卡列列表
  'postCardsList':params => post(INTERFACE_URL.codesList, params, 'form'),
  // 2.2 搜索卡商品
  'postCardSearch':params => post(INTERFACE_URL.cardSearch, params, 'form'),
  // 2.2 搜索卡商品
  'postCardOnSale':params => post(INTERFACE_URL.cardOnSale, params, 'form'),
  // 2.4 修改批次
  'postCardChangeBatch':params => post(INTERFACE_URL.cardChangeBatch, params, 'form'),
